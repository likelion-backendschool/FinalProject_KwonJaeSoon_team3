...
import com.ll.ebook.app.product.exception.ActorCanNotModifyException;
...
public class ProductController {
    ...
    public String tagList(Model model, @PathVariable String tagContent) {
        List<ProductHashTag> productTags = productService.getProductTags(tagContent, rq.getMember());
